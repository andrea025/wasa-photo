...
export default {
  ...
  methods: {
    async getLikes() {
      this.errormsg = null;
      try {
        let response = await this.$axios.get(this.$route.path.split("/likes")[0]);
        this.likes = response.data.likes.users;
      } catch (e) {
                  ...
                  <div style="max-height: 400px; min-height: 260px;">
                      ...
                      <div class="ctn-8">
                        <div class="ctn-9" style="height: 100%; width: 100%;">
                          <h1 class="ctn-10" style="width: calc(100% - 100px);">
                            <div style="margin-left:42px">Likes</div>
                          </h1>
                          <div class="ctn-11">
                            <div class="ctn-12">
                    ...
                    <div>
                      <div style="max-height: 358px; overflow-y: auto;">
                        <div style="position: relative; display: flex; flex-direction: column; padding-bottom: 0px; padding-top: 0px;" v-for="user in this.likes">
                          <div class="ctn-15">
