                    ...
                    <div style="max-height: 400px; min-height: 260px;">
                        ...
                        <div class="ctn-8">
                          <div class="ctn-9" style="height: 100%; width: 100%;">
                            <h1 class="ctn-10" style="width: calc(100% - 100px);">
                              <div style="margin-left:42px">Followers</div>
                            </h1>
                            <div class="ctn-11">
                              <div class="ctn-12">
                      ...
                      <div>
                        <div style="max-height: 358px; overflow-y: auto;">
                          <div style="position: relative; display: flex; flex-direction: column; padding-bottom: 0px; padding-top: 0px;" v-for="user in this.followers" :key="user">
                            <div class="ctn-15">
